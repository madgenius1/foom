  ...
  const renderStep = () => {
    switch (currentStep) {
      case 1:
        return (
          <View>
            <Icon name="phone" size={64} color="#6200EE" style={styles.stepIcon} />
      ...
      case 2:
        return (
          <View>
            <Icon name="target" size={64} color="#FF9800" style={styles.stepIcon} />
      ...
      case 3:
        return (
          <View>
            <Icon name="trending-up" size={64} color="#4CAF50" style={styles.stepIcon} />
            ...
            <RadioButton.Group
              onValueChange={(value) => setFormData({...formData, selectedMMF: value})}
      ...
      case 4:
        return (
          <View>
            <Icon name="clock-outline" size={64} color="#9C27B0" style={styles.stepIcon} />
            ...
            <TextInput
              ...
              onChangeText={(text) => setFormData({...formData, screenTimeGoal: text})}
              mode="outlined"
              keyboardType="numeric"
            ...
            <Card style={styles.infoCard}>
              <Card.Content>
                ...
                <Text style={styles.infoText}>
                  • Stay under {formData.screenTimeGoal || 8} hours daily to earn tokens
                </Text>
                <Text style={styles.infoText}>
